...
/*
 The class is designed to work with the API crpt.ru .
 Supports a limit on the number of API requests in a given time period.
 */
public class CrptApi {
    ...
    public CrptApi(TimeUnit timeUnit, int requestLimit, String apiUrl) {
        //the unit of time for the query interval
        this.timeUnit = timeUnit;
        //the maximum number of requests in a given time interval
    ...
    private void processResponseBody(String responseBody) {
        // TODO add response body processing
    }
